...
%         spikeDataSet      = getSyntheticSpikeDeconvDataNLVersion(nDataSet, median_r, tau_d_list(nTau), params, nlParams);   %#ok<*NASGU>
%         save([TempDatDir 'directNLDeconv/' DataSetList(nData).name '_Tau' num2str(nTau, '%02d') '.mat'], 'spikeDataSet');
%         clear spikeDataSet
%     end
% end
