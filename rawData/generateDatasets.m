...
load([tempDatOld DataSetList(1).name '.mat'], 'nDataSet');
...
load([tempDatOld DataSetList(2).name '_withOLRemoval.mat'], 'nDataSet');
...
load([tempDatOld DataSetList(3).name '_withOLRemoval.mat'], 'nDataSet');
nonActiveNeuronIndex   = findNonActiveNeurons(nDataSet, params);
...
load([tempDatOld DataSetList(4).name '_withOLRemoval.mat'], 'nDataSet');
nonActiveNeuronIndex   = findNonActiveNeurons(nDataSet, params);
...
load([tempDatOld DataSetList(5).name '_withOLRemoval.mat'], 'nDataSet');
nonActiveNeuronIndex   = findNonActiveNeurons(nDataSet, params);
...
load([tempDatOld DataSetList(6).name '_withOLRemoval.mat'], 'nDataSet');
nonActiveNeuronIndex   = findNonActiveNeurons(nDataSet, params);
...
load([tempDatOld DataSetList(7).name '.mat'], 'nDataSet');
...
load([tempDatOld DataSetList(8).name '.mat'], 'nDataSet');
...
load([tempDatOld DataSetList(9).name '.mat'], 'nDataSet');
nonActiveNeuronIndex   = findNonActiveNeurons(nDataSet, params);
...
load([tempDatOld DataSetList(10).name '_withOLRemoval.mat'], 'nDataSet');
nonActiveNeuronIndex   = findNonActiveNeurons(nDataSet, params);
...
load([tempDatOld DataSetList(11).name '.mat'], 'nDataSet');
...
load([tempDatOld DataSetList(12).name '_withOLRemoval.mat'], 'nDataSet');
nonActiveNeuronIndex   = findNonActiveNeurons(nDataSet, params);
