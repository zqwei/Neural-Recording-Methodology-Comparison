...
mean_ = [0.6698    0.8349    0.9006;
         0.6062    0.8948    0.9628;
         0.6439    0.8625    0.9396;
         0.6299    0.8989    0.9797;
         0.6567    0.8712    0.9684;
        ];


std_  = [0.0875    0.0365    0.0523;
         0.1155    0.0407    0.0210;
         0.1339    0.0368    0.0461;
         0.0752    0.0669    0.0178;
         0.0746    0.0839    0.0130;
        ];
